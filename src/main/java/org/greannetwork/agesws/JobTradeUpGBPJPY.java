 ...
 * @author San
 */
public class JobTradeUpGBPJPY implements Job {

    private static final Log log = LogFactory.getLog(JobTradeUpGBPJPY.class.getName());
    ...
    public Bar[] getBar() {
        ...
        Bar[] bars = new Bar[0];
        try {
            bars = proxy.getBars("GBP/JPY", "5 Minutes", "f");
    ...
    public void execute(JobExecutionContext jec) throws JobExecutionException {
        ...
        if (!buyState && sum > 0) {
            System.out.println(">>>>> " + bars[i].getBarDateTime().getTime() + " BUY GBP/JPY " + closeArray[i] + " => MACD[" + result[0] + "] LM[" + result[1] + "] EMA[" + result[2] + "] RSI[" + result[3] + "] STO[" + result[4] + "]");
            log.info(bars[i].getBarDateTime().getTime() + " BUY GBP/JPY " + closeArray[i] + " => MACD[" + result[0] + "] LM[" + result[1] + "] EMA[" + result[2] + "] RSI[" + result[3] + "] STO[" + result[4] + "]");
        ...
        if (!sellState && sum < 0) {
            ...
            System.out.println(bars[i].getBarDateTime().getTime() + " NOTHING GBP/JPY " + closeArray[i] + " => MACD[" + result[0] + "] LM[" + result[1] + "] EMA[" + result[2] + "] RSI[" + result[3] + "] STO[" + result[4] + "]");
        }
    }
